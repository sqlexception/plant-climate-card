      ...
      <ha-card>
        <div class="card">
          ...
          <div class="bottom-controls ${v}">
            ...
            ${!1!==this.config.show_fan?w.map(t=>F`
                    <button
                      type="button"
                      class="icon-control fan ${t===A?"active":""}"
